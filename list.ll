...
11:                                               ; preds = %2
  call void @__assert_fail(i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 noundef 23, i8* noundef getelementptr inbounds ([39 x i8], [39 x i8]* @__PRETTY_FUNCTION__.Vector_get, i64 0, i64 0)) #6
  unreachable
...
define dso_local void @Vector_grow(%struct.Vector* noundef %0) #0 {
  ...
  %29 = load %struct.Vector*, %struct.Vector** %2, align 8
  %30 = getelementptr inbounds %struct.Vector, %struct.Vector* %29, i32 0, i32 2
...
16:                                               ; preds = %14, %2
  ...
  %28 = load %struct.Vector*, %struct.Vector** %3, align 8
  %29 = getelementptr inbounds %struct.Vector, %struct.Vector* %28, i32 0, i32 0
...
9:                                                ; preds = %1
  call void @__assert_fail(i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 noundef 63, i8* noundef getelementptr inbounds ([34 x i8], [34 x i8]* @__PRETTY_FUNCTION__.Vector_pop, i64 0, i64 0)) #6
  unreachable

10:                                               ; preds = %8
  %11 = load %struct.Vector*, %struct.Vector** %2, align 8
  %12 = getelementptr inbounds %struct.Vector, %struct.Vector* %11, i32 0, i32 2
  ...
  %25 = load %struct.Vector*, %struct.Vector** %2, align 8
  %26 = getelementptr inbounds %struct.Vector, %struct.Vector* %25, i32 0, i32 0
  %27 = load i32, i32* %26, align 8
  %28 = load %struct.Vector*, %struct.Vector** %2, align 8
...
33:                                               ; preds = %10
  %34 = load %struct.Vector*, %struct.Vector** %2, align 8
  call void @Vector_shrink(%struct.Vector* noundef %34)
  br label %35
...
define dso_local i32 @main() #0 {
  ...
  %6 = call %struct.Vector* @Vector_alloc()
  store %struct.Vector* %6, %struct.Vector** %2, align 8
  ...
  call void @Vector_push(%struct.Vector* noundef %13, i8* noundef %15)
  %16 = load %struct.Vector*, %struct.Vector** %2, align 8
  %17 = load i32*, i32** %4, align 8
  %18 = bitcast i32* %17 to i8*
  call void @Vector_push(%struct.Vector* noundef %16, i8* noundef %18)
  %19 = load %struct.Vector*, %struct.Vector** %2, align 8
  %20 = call i8* @Vector_get(%struct.Vector* noundef %19, i32 noundef 0)
  ...
  %25 = load %struct.Vector*, %struct.Vector** %2, align 8
  call void @Vector_free(%struct.Vector* noundef %25)
  ret i32 0
}
